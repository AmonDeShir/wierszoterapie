...
export const AboutMe = ({children, hasNav }: PropsWithChildren<PartProps>) => (
  <Part hasNav={hasNav}>
    ...
    <Hero image={author} title="O mnie" align="justify" imageAlign="bottom" >
      ...
      <br/><br/>
      Jeżeli podoba Ci się moja twórczość, cenisz poezję, zapraszam do polubienia i obserwowania <a className="link" style={{ textDecoration: "underline", textDecorationColor: "#DF0036", color: "#DF0036" }} href="https://www.facebook.com/profile.php?id=61558898596972">mojego profilu autorskiego</a> na Facebooku.
    </Hero>
  </Part>
);